! function(e, t, r, a, i) {
    ...
    abjMI: [function(e, t, r) {
        ...
        var i = e("bundle-text:./style/index.less"),
            ...
            R = e("./notice"),
            A = a.interopDefault(R),
            L = e("./mask"),
            P = a.interopDefault(L),
            N = e("./icons"),
            Z = a.interopDefault(N),
            _ = e("./setting"),
            q = a.interopDefault(_),
            V = e("./storage"),
        ...
        r.default = G, G.STYLE = o.default, G.DEBUG = !1, G.CONTEXTMENU = !0, G.NOTICE_TIME = 2e3, G.SETTING_WIDTH = 250, G.SETTING_ITEM_WIDTH = 200, G.SETTING_ITEM_HEIGHT = 35, G.RESIZE_TIME = 200, G.SCROLL_TIME = 200, G.SCROLL_GAP = 50, G.AUTO_PLAYBACK_MAX = 10, G.AUTO_PLAYBACK_MIN = 5, G.AUTO_PLAYBACK_TIMEOUT = 3e3, G.RECONNECT_TIME_MAX = 5, G.RECONNECT_SLEEP_TIME = 1e3, G.CONTROL_HIDE_TIME = 3e3, G.DBCLICK_TIME = 300, G.DBCLICK_FULLSCREEN = !0, G.MOBILE_DBCLICK_PLAY = !0, G.MOBILE_CLICK_PLAY = !1, G.AUTO_ORIENTATION_TIME = 200, G.INFO_LOOP_TIME = 1e3, G.FAST_FORWARD_VALUE = 3, G.FAST_FORWARD_TIME = 1e3, G.TOUCH_MOVE_RATIO = .5, G.VOLUME_STEP = .1, G.SEEK_STEP = 5, G.PLAYBACK_RATE = [.5, .75, 1, 1.25, 1.5, 2], G.ASPECT_RATIO = ["default", "4:3", "16:9"], G.FLIP = ["normal", "horizontal", "vertical"], G.FULLSCREEN_WEB_IN_BODY = !1, G.LOG_VERSION = !0, G.USE_RAF = !1, u.isBrowser && (window.Artplayer = G, u.setStyleText("artplayer-style", o.default), setTimeout(() => {
            G.LOG_VERSION && console.log(`%c vidplay.cc %c ${G.version} %c https://vidplay.cc`, "color: #fff; background: #5f5f5f", "color: #fff; background: #4bc729", "")
        }, 100))
    }, {
        ...
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = class {
            ...
            off(e, t) {
                let r = this.e || (this.e = {}),
                    ...
                    i = [];
                if (a && t)
                    for (let e = 0, r = a.length; e < r; e += 1) a[e].fn !== t && a[e].fn._ !== t && i.push(a[e]);
    ...
    XgAQE: [function(e, t, r) {
        ...
        function y(e, t = 0) {
            let r = e.getBoundingClientRect(),
                ...
                o = r.top - t <= a && r.top + r.height + t >= 0,
    ...
    luXC1: [function(e, t, r) {
        ...
        let i = "undefined" != typeof navigator ? navigator.userAgent : "",
            o = /^((?!chrome|android).)*safari/i.test(i),
            n = /MicroMessenger/i.test(i),
            s = /MSIE|Trident/i.test(i),
            l = /android/i.test(i),
            c = /iPad|iPhone|iPod/i.test(i) && !window.MSStream,
    ...
    "556MW": [function(e, t, r) {
        ...
        var i = e("./urlMix"),
            ...
            A = e("./playedMix"),
            L = a.interopDefault(A),
            P = e("./playingMix"),
            N = a.interopDefault(P),
            Z = e("./autoSizeMix"),
            _ = a.interopDefault(Z),
            q = e("./rectMix"),
    ...
    "7m6R8": [function(e, t, r) {
        ...
        function o(e) {
            ...
            (0, i.def)(e, "aspectRatio", {
                ...
                set(n) {
                    if (n || (n = "default"), "default" === n)(0, i.setStyle)(a, "width", null), (0, i.setStyle)(a, "height", null), (0, i.setStyle)(a, "margin", null), delete o.dataset.aspectRatio;
                    else {
    ...
    fKDW8: [function(e, t, r) {
        ...
        function s(e) {
            ...
            e.once("video:loadedmetadata", () => {
                o.default.isEnabled ? s(e) : a.webkitSupportsFullscreen ? l(e) : (0, n.def)(e, "fullscreen", {
                    get: () => !1,
                    set() {
    ...
    "9ZPBQ": [function(e, t, r) {
        ...
        function o(e) {
            ...
            function d() {
                let {
                    $mini: t
                } = e.template, r = (0, i.getRect)(t), o = window.innerHeight - r.height - 50, n = window.innerWidth - r.width - 50;
    ...
    guki8: [function(e, t, r) {
        ...
        r.default = class {
            ...
            addSelector(e, t, r) {
                ...
                let u = () => {
                    let e = (0, i.getStyle)(t, "width"),
                        r = (0, i.getStyle)(c, "width");
            ...
            return t => ({
                ...
                mounted: e => {
                    let {
                        ...
                        icons: a,
                        i18n: o
                    } = t, n = (0, i.append)(e, a.fullscreenOn), s = (0, i.append)(e, a.fullscreenOff);
            ...
            return t => ({
                ...
                mounted: e => {
                    let {
                        ...
                        icons: a,
                        i18n: o
                    } = t, n = (0, i.append)(e, a.fullscreenWebOn), s = (0, i.append)(e, a.fullscreenWebOff);
                    (0, i.setStyle)(s, "display", "none"), r(e, "click", () => {
            ...
            return t => ({
                ...
                mounted: e => {
                    let {
                        ...
                        icons: a,
                        i18n: o
                    } = t, n = (0, i.append)(e, a.play), s = (0, i.append)(e, a.pause);
    ...
    aBBSH: [function(e, t, r) {
        ...
        function o(e, t) {
            let {
                ...
                left: a
            } = (0, i.getRect)(r), o = i.isMobile ? t.touches[0].clientX : t.clientX, n = (0, i.clamp)(o - a, 0, r.clientWidth), s = n / r.clientWidth * e.duration, l = (0, i.secondToTime)(s), c = (0, i.clamp)(n / r.clientWidth, 0, 1);
            return {
                second: s,
                time: l,
                width: n,
            ...
            return t => {
                ...
                return {
                    ...
                    mounted: e => {
                        let l = null,
                            c = !1,
                            u = (0, i.query)(".art-progress-hover", e),
                            p = (0, i.query)(".art-progress-loaded", e),
                        ...
                        function g(r, a) {
                            ...
                            m.innerText = s;
                            let l = m.clientWidth;
                            n <= l / 2 ? (0, i.setStyle)(m, "left", 0) : n > e.clientWidth - l / 2 ? (0, i.setStyle)(m, "left", `${e.clientWidth-l}px`) : (0, i.setStyle)(m, "left", `${n-l/2}px`)
                        }
                        r.indicator ? (0, i.append)(h, r.indicator) : (0, i.setStyle)(h, "backgroundColor", "var(--art-theme)"), t.on("setBar", function(r, a, o) {
                            let n = "played" === r && o && i.isMobile;
                            "loaded" === r && (0, i.setStyle)(p, "width", `${100*a}%`), "hover" === r && (0, i.setStyle)(u, "width", `${100*a}%`), "played" === r && ((0, i.setStyle)(d, "width", `${100*a}%`), (0, i.setStyle)(h, "left", `${100*a}%`)), n && ((0, i.setStyle)(m, "display", "flex"), g(o, {
                            ...
                            for (let e = 0; e < a.highlight.length; e++) {
                                let r = a.highlight[e],
                                    o = (0, i.clamp)(r.time, 0, t.duration) / t.duration * 100,
                        ...
                        }), t.emit("setBar", "loaded", t.loaded || 0), i.isMobile || (s(e, "click", e => {
                            e.target !== h && n(t, e)
                        }), s(e, "mousemove", r => {
                            let {
                                percentage: a
                            } = o(t, r);
                            t.emit("setBar", "hover", a, r), (0, i.setStyle)(m, "display", "flex"), (0, i.includeFromEvent)(r, f) ? function(r) {
                                let {
                                    width: a
                                } = o(t, r), {
                                    text: n
                                ...
                                m.innerText = n;
                                let s = m.clientWidth;
                                a <= s / 2 ? (0, i.setStyle)(m, "left", 0) : a > e.clientWidth - s / 2 ? (0, i.setStyle)(m, "left", `${e.clientWidth-s}px`) : (0, i.setStyle)(m, "left", `${a-s/2}px`)
                            }(r) : g(r)
                        }), s(e, "mouseleave", e => {
                            (0, i.setStyle)(m, "display", "none"), t.emit("setBar", "hover", 0, e)
                        }), s(e, "mousedown", e => {
                            c = 0 === e.button
        ...
        function o(e) {
            return t => ({
                ...
                mounted: e => {
                    ...
                    function m() {
                        if (t.muted || 0 === t.volume)(0, i.setStyle)(o, "display", "none"), (0, i.setStyle)(n, "display", "flex"), (0, i.setStyle)(f, "top", "100%"), (0, i.setStyle)(d, "top", "100%"), c.innerText = 0;
                        else {
                            let e = 100 * t.volume;
    ...
    f1W36: [function(e, t, r) {
        ...
        function o(e) {
            return t => {
                ...
                } = t, o = a.map(e => `<span data-value="${e}">${1===e?r.get("Normal"):e.toFixed(1)}</span>`).join("");
                return {
                    ...e,
    ...
    afxZC: [function(e, t, r) {
        ...
        function o(e) {
            return t => {
                ...
                } = t, o = a.map(e => `<span data-value="${e}">${"default"===e?r.get("Default"):e}</span>`).join("");
                return {
                    ...e,
    ...
    "9jCuX": [function(e, t, r) {
        ...
        function o(e) {
            return t => {
                ...
                } = t, o = a.map(e => `<span data-value="${e}">${r.get((0,i.capitalize)(e))}</span>`).join("");
                return {
                    ...e,
    ...
    bb0TU: [function(e, t, r) {
        ...
        function i(e) {
            return {
                ...e,
                html: '<a href="https://vidplay.cc" target="_blank">vidplay 5.1.7</a>'
            }
        }
        a.defineInteropFlag(r), a.export(r, "default", () => i)
    }, {
        ...
        function n(e, t) {
            if (i.isMobile && !e.option.isLive) {
                let {
                    $video: r,
                    $progress: a
                } = e.template, n = null, s = !1, l = 0, c = 0, u = 0, p = t => {
                    ...
                    if (1 === t.touches.length && s && e.duration) {
                        ...
                        if (p && !e.isRotate || d && e.isRotate) {
                            let s = (0, i.clamp)((a - l) / e.width, -1, 1),
                                p = (0, i.clamp)((o - c) / e.height, -1, 1),
                                d = e.isRotate ? p : s,
                                f = n === r ? e.constructor.TOUCH_MOVE_RATIO : 1,
                                h = (0, i.clamp)(u + e.duration * d * f, 0, e.duration);
                            e.seek = h, e.emit("setBar", "played", (0, i.clamp)(h / e.duration, 0, 1), t), e.notice.show = `${(0,i.secondToTime)(h)} / ${(0,i.secondToTime)(e.duration)}`
                        }
                    }
                };
        ...
        class s extends n.default {
            constructor(e) {
                ...
                let {
                    ...
                    icons: r,
                    events: a
                } = e, o = (0, i.append)(t.$state, r.state), n = (0, i.append)(t.$state, r.error);
    ...
    "6dYSr": [function(e, t, r) {
        ...
        var i = e("../utils"),
            ...
            q = a.interopDefault(_),
            V = e("bundle-text:./fullscreen-web-on.svg"),
            W = a.interopDefault(V),
            U = e("bundle-text:./switch-on.svg"),
            Y = a.interopDefault(U),
            K = e("bundle-text:./switch-off.svg"),
            X = a.interopDefault(K),
            G = e("bundle-text:./flip.svg"),
            J = a.interopDefault(G),
        ...
        r.default = class {
            constructor(e) {
                ...
                for (let e in t)(0, i.def)(this, e, {
                    get: () => (0, i.getIcon)(e, t[e])
                })
            }
        }
    }, {
    ...
    bRHiA: [function(e, t, r) {
        ...
        class g extends f.default {
            ...
            init() {
                let {
                    option: e
                } = this.art, t = [...this.defaultSettings, ...e.settings];
            ...
            creatItem(e, t) {
                ...
                let n = (0, m.append)(o, '<div class="art-setting-item-left"></div>'),
                    s = (0, m.append)(o, '<div class="art-setting-item-right"></div>'),
                ...
                switch ((0, m.addClass)(u, "art-setting-item-right-tooltip"), (0, m.append)(u, t.tooltip || ""), (0, m.append)(s, u), t.$tooltip = u, (0, m.def)(t, "tooltip", {
                    ...
                    case "switch": {
                        ...
                        let a = (0, m.append)(e, r.switchOn),
                            i = (0, m.append)(e, r.switchOff);
                ...
                switch (e) {
                    ...
                    case "selector": {
                        let e = a(o, "click", async e => {
                            if (t.selector && t.selector.length) this.render(t.selector, t.width);
                            else {
            ...
            updateStyle(e) {
                ...
                if (t.setting && !m.isMobile) {
                    let o = e || r.SETTING_WIDTH,
                        {
                            left: n,
                            width: s
                        } = (0, m.getRect)(t.setting),
                        {
                            left: l,
                            width: c
                        } = (0, m.getRect)(a),
